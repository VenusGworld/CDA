    ...
    success: function(resp){
        for(x in resp){
           dataresp = {
            ...
            grupo: resp[x].grupo,
            editar: `<div style="width: 100%;display: flex;align-items: center;text-align: center;justify-content: center;"><a href="/admin/editar-usuario/${resp[x].id}" class="btn btn-warning btn-sm"><i class="fa-regular fa-pen-to-square"></i></a></div>`,
